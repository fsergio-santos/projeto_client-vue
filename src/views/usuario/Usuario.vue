...
<template>
  <div>
    <Cabecalho
      :tituloPagina="'Cadastro de Usuários'"
      :link="'/usuario/lista'"
                    ...
                    <div class="form-group">
                      ...
                      <div class="invalid-feedback" v-if="errors">
                        <p>
                          <span
                            v-if="errorNameLen"
                          >O nome deve conter mais de 5 caracteres e no máximo 100 caracteres</span>
                        </p>
                        <p>
                          <span v-if="errorNameNull">O nome deve ser informado!</span>
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="form-group">
                      ...
                      <div class="invalid-feedback" v-if="errors">
                        <p>
                          <span
                            v-if="errorUserNameLen"
                          >O nome do usuário deve conter mais de 5 caracteres e no máximo 20 caracteres</span>
                        </p>
                        <p>
                          <span v-if="errorUserNameNull">O nome deve ser informado!</span>
                        </p>
                      </div>
                    </div>
                  </div>
                  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="form-group">
                      ...
                      <div class="invalid-feedback" v-if="errors">
                        <p>
                          <span v-if="errorEmailInvalid">O E-mail informado é inválido</span>
                        </p>
                        <p>
                          <span v-if="errorEmailExist">O E-mail já já existe na base de dados</span>
                        </p>
                        <p>
                          <span v-if="errorEmailNull">O E-mail deve ser informado!</span>
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="form-group">
                      ...
                      <div class="invalid-feedback" v-if="errors">
                        <p>
                          <span v-if="errorPasswordLen">A Senha deve conter 8 caracteres</span>
                        </p>
                        <p>
                          <span v-if="errorPasswordNull">A Senha deve ser informada!</span>
                        </p>
                        <p>
                          <span
                            v-if="errorPasswordBlank"
                          >A Senha não pode conter caracteres em branco!</span>
                        </p>
                      </div>
                    </div>
                  </div>
                  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="form-group">
                      ...
                      <div class="invalid-feedback" v-if="errors">
                        <p>
                          <span v-if="errorContraSenhaLen">A Senha deve conter 8 caracteres</span>
                        </p>
                        <p>
                          <span v-if="errorContraSenhaNull">A Senha deve ser informada!</span>
                        </p>
                        <p>
                          <span
                            v-if="errorContraSenhaBlank"
                          >A Senha não pode conter caracteres em branco!</span>
                        </p>
                        <p>
                          <span
                            v-if="errorContraSenhaPassword"
                          >A Contra Senha está diferente da Senha!</span>
                        </p>
                      </div>
                    </div>
                  </div>
...
export default {
  ...
  methods: {
    ...
    isUnique(email) {
      ...
      return new Promise((resolve, reject) => {
        ...
        axios
          .get(url)
          .then(res => {
            this.isExistEmail(res.data);
          })
          .catch(error => {
            this.isExistEmail(error.response.data), reject(error);
          });
      });
    },
    isExistEmail(data) {
    ...
    dataFromTable(user) {
      ...
      this.urlFoto = user.url
      this.setPhoto(this.urlFoto)
    },
    setPhoto(photo){
      this.$store.dispatch("initPhoto", photo)
    },
